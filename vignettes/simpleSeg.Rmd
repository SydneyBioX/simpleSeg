...
```
# Normalizing cells
Once cellular features have been extracted into a singleCellExperement or dataframe, these features may then be normalized using the `normalizeCells`function.
```{r}
cell.sce.norm <- normalizeCells(cell.sce, markers = c("CD99", "PIN", "CD8a", "CDH"), assayIn = "counts", assayOut = "counts.norm", imageID = "imageNb", transformation = "asinh", method = c("mean", "trim99"))
```
